...
public:
	...
	void trainNetwork( vector<dataEntry*> trainingSet, vector<dataEntry*> generalizationSet, vector<dataEntry*> validationSet )
	{
		...
		{			
			...
			{	
				cout << "Epoch :" << epoch;
				cout << " Training Set ACC:" << trainingSetAccuracy << "%, MSE: " << trainingSetMSE ;
		...
		logFile << "Training Complete!\nElapsed Epochs: " << epoch << "Test Set ACC: " << validationSetAccuracy << " MSE: " << validationSetMSE << endl;
				
		//out validation accuracy and MSE
		cout << endl << "Training Complete!\nElapsed Epochs: " << epoch << endl;
		cout << " Validation Set ACC: " << validationSetAccuracy << endl;
